...
const Home = () => {
  return (
    <div className='home'>
      <Navbar/>
      <div className='hero'>
        <img src={hero_banner} alt="hero banner image" className='banner-img' />
        <div className='hero-caption'>
            <img src={hero_title} alt="hero image caption" className='caption-img' />
        ...
        <div className='hero-btns'>
          ...
          <button className='btn dark-btn'><img src={info_icon} alt="More info button" />More Info</button>
        </div>
        <TitleCards/>
        </div>
      </div>
